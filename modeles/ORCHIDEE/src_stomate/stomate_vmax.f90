...
!! SUBROUTINE    : vmax
!!
!>\BRIEF         This subroutine computes vjmax and vcmax photosynthesis parameters 
!! given optimal vjmax and vcmax parameter values and a leaf age-related efficiency.
!!
...
!! vcmax and vjmax are defined as vcmax_opt and vjmax_opt weighted by a mean leaf
!! efficiency. vjmax_opt and vcmax_opt are PFT-dependent constants defined in stomate_constants.f90.
!!
!! This routine is called once at the beginning by stomate_var_init and then at each stomate time step by stomateLpj.
!!
!! RECENT CHANGE(S): None
!!
!! MAIN OUTPUT VARIABLE(S): vcmax and vjmax
!!
!! REFERENCE(S)	: 
...
!_ ================================================================================================================================
  ...
  SUBROUTINE vmax (npts, dt, &
    ...
    !! 0.4 Local variables
    !
    REAL(r_std), DIMENSION(npts)                               :: leaf_efficiency         !! leaf efficiency (vcmax/vcmax_opt)
                                                                                          !! (unitless)
