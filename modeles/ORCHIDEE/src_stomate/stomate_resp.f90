...
!! 0. Variable and parameter declaration
    ...
    REAL(r_std), DIMENSION(npts,nvm), INTENT(in)       :: rprof     !! PFT root depth as calculated in stomate.f90 from parameter 
                                                                    ...
                                                                    !! in slowproc.f90 (m)
    REAL(r_std), DIMENSION(npts,nvm,nparts),INTENT(in) :: biomass   !! PFT total biomass calculated in stomate_alloc.f90 
                                                                    !! @tex $(gC.m^{-2})$ @endtex
    ...
    REAL(r_std), DIMENSION(npts,nvm)        :: lai                  !! PFT leaf area index @tex $(m^2 m^{-2})$ @endtex
    ...
    REAL(r_std), DIMENSION(npts,nparts)     :: t_maint              !! [DISPENSABLE] Temperature which is pertinent for maintenance
                                                                    !! respiration - not used here (K)
...
!_ ================================================================================================================================
 ...
 !! 2. Define maintenance respiration coefficients
    ...
    DO j = 2,nvm ! Loop over # PFTs
       ...
       !     - Coeff_maint_zero is defined in defined in stomate_constants.f90 (cm_zero_plantpartname)
