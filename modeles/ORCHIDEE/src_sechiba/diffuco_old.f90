      ...
      DO ji = 1, kjpindex
         ...
         IF ( ( veget(ji,jv)*lai(ji,jv) .GT. min_sechiba ) .AND. &
            ...
            vbeta3(ji,jv) = veget(ji,jv) * (un - zqsvegrap(ji)) * humrel(ji,jv) * &
                 ...
                 write(*,*) 'Chloe rstruct ', rstruct(1,14)
                 write(*,*) 'Chloe vbeta3', vbeta3(1,14) 
            ! Fin ajout Nathalie
...
! N. de Noblet - 2006/06 
    ...
    DO jv = 2,nvm
      ...
      DO ji=1,kjpindex
        !
        write(*,*) 'Chloe lai', lai(ji,14)
        write(*,*) 'Chloe veget_max', veget_max(ji,14)
        write(*,*) 'Chloe veget', veget(ji,14)
        write(*,*) 'Chloe swdown', swdown(ji)
        write(*,*) 'Chloe temp_air', temp_air(ji)
        write(*,*) 'Chloe humrel', humrel(ji,jv)
...
!               zqsvegrap(iainia) * humrel(iainia,jv) * &
        ...
        !Chloe : 
        write(*,*) 'Je suis passe par la'
        write(*,*) 'Chloe rstruct',rstruct(1,14)
        write(*,*) 'Chloe vbeta3', vbeta3(:,14)
